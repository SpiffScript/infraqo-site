...
/**
 *  NOTE TO SELF RE LOGO COMPONENT:
 ...
 *  in index.css.
 *
 *  Without injecting directly into the DOM, the animation property is applied
 *  but never executed. This inline block ensures the animation always exists 
 *  at runtime, regardless of how Cloudflare processes CSS.
 * ----------------------------------------------------------------------------
 */
