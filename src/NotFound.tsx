      ...
      <div className="relative max-w-3xl w-full text-center">
        ...
        <div className="relative bg-slate-900/70 border border-slate-800/80 px-8 py-10 shadow-xl backdrop-blur">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a
              href="/"
              className="inline-flex items-center justify-center px-6 py-2.5 text-sm font-medium text-slate-50 bg-blue-500/90 hover:bg-blue-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 shadow-[0_0_18px_rgba(59,130,246,0.7)] transition"
            >
              Take me home
            </a>
            ...
            <a
              href="/services"
              className="inline-flex items-center justify-center px-6 py-2.5 text-sm font-medium text-slate-100 border border-slate-600 bg-slate-900/60 hover:bg-slate-800/80 hover:border-blue-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 shadow-[0_0_18px_rgba(15,23,42,0.8)] transition"
            >
              View services
            </a>
            ...
            <a
              href="/contact"
              className="inline-flex items-center justify-center px-6 py-2.5 text-sm font-medium text-blue-300 border border-blue-500/60 bg-slate-900/40 hover:bg-blue-500/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 shadow-[0_0_18px_rgba(59,130,246,0.7)] transition"
            >
              Contact support
            </a>
          </div>
          ...
          <p className="mt-8 text-xs sm:text-sm text-slate-500">
            If you are seeing this, don't worry: The internet still works.
          </p>
        </div>
      </div>
    </main>
